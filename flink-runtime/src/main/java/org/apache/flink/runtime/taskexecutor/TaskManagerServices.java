...
public class TaskManagerServices {
    ...
    public static TaskManagerServices fromConfiguration(
        ...
        /**
         * 创建并启动ShuffleEnvironment,后续的shuffle操作通过这个完成
         */
        ...
        /**
         * KV状态服务(checkpoint、savepoint中算子的状态管理)，里面三个组件KvStateRegistry、KvStateServer、KvStateClientProxy
         * KvStateRegistry：用于kv状态注册
         * KvStateServer：集群中每个任务管理器上运行的可查询状态服务器的接口。该服务器负责处理来自可查询状态代理的请求并请求本地存储的状态。
         * KvStateClientProxy：集群中每个任务管理器上运行的可查询状态客户端代理的接口
         */
