...
public class DefaultDispatcherResourceManagerComponentFactory
    ...
    public DispatcherResourceManagerComponent create(
        ...
        try {
            /** 创建 dispatcherLeader 高可用检索服务 对应实现类 DefaultLeaderRetrievalService */
            dispatcherLeaderRetrievalService =
                    highAvailabilityServices.getDispatcherLeaderRetriever();

            /** 创建 resourceManager 高可用检索服务 对应实现类 DefaultLeaderRetrievalService */
            ...
            /**
             * 创建并启动 webMonitorEndpoint 1.注册所有的handler，启动netty服务端，把handler注册到netty上，处理各种rest请求
             * 2.调用startInternal方法，这个方法主要做两件事 1.选举 2.启动executorGraphCache缓存定时清理任务
             */
            webMonitorEndpoint =
